...
getTableScore score 9 (a:b:c:[]) =  if    (a+b+c) == 30 then getTableScore score 9 [a] ++   " "   ++ getTableScore  score          9    [b]     ++   " "  ++ getTableScore (score+a+b+c) 10   [c]
                                    else if (a+b) == 10 then getTableScore score 9 [a] ++  " / "  ++ getTableScore (score+a+b+c)   10   [c]
